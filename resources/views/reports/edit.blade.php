...
@section('title', 'Edit Replenishment Report #' . $report->id)
@section('page-title', 'Edit Replenishment Report')

@section('content')
<a href="{{ route('reports.show', $report) }}" style="display:inline-flex;align-items:center;gap:6px;color:var(--text-secondary);text-decoration:none;font-size:0.82rem;font-weight:500;margin-bottom:16px;" onmouseover="this.style.color='var(--primary)'" onmouseout="this.style.color='var(--text-secondary)'">
        ...
        <div class="card-body">
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="text" name="project_name" id="project_name" class="form-control" value="{{ old('project_name', $report->project_name) }}" required>
                    @error('project_name')
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="location" id="location" class="form-control" value="{{ old('location', $report->location) }}" required>
                    @error('location')
                        <div style="color:var(--danger);font-size:0.8rem;margin-top:6px;">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="form-group">
                ...
                <input type="text" name="subject" id="subject" class="form-control" value="{{ old('subject', $report->subject) }}" required>
                @error('subject')
                    <div style="color:var(--danger);font-size:0.8rem;margin-top:6px;">{{ $message }}</div>
                @enderror
            </div>
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="date" name="period_start" id="period_start" class="form-control" value="{{ old('period_start', $report->period_start->format('Y-m-d')) }}" required>
                    @error('period_start')
                        <div style="color:var(--danger);font-size:0.8rem;margin-top:6px;">{{ $message }}</div>
                    @enderror
                </div>
                <div class="form-group">
                    ...
                    <input type="date" name="period_end" id="period_end" class="form-control" value="{{ old('period_end', $report->period_end->format('Y-m-d')) }}" required>
                    @error('period_end')
                        <div style="color:var(--danger);font-size:0.8rem;margin-top:6px;">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="number" name="cash_received" id="cash_received" class="form-control" step="0.01" min="0" value="{{ old('cash_received', $report->cash_received) }}" required>
                    @error('cash_received')
                        <div style="color:var(--danger);font-size:0.8rem;margin-top:6px;">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="text" name="prepared_by" id="prepared_by" class="form-control" value="{{ old('prepared_by', $report->prepared_by) }}" required>
                    @error('prepared_by')
                        <div style="color:var(--danger);font-size:0.8rem;margin-top:6px;">{{ $message }}</div>
                    @enderror
                </div>
                <div class="form-group">
                    ...
                    <input type="text" name="reviewed_by" id="reviewed_by" class="form-control" value="{{ old('reviewed_by', $report->reviewed_by) }}" required>
                    @error('reviewed_by')
                        <div style="color:var(--danger);font-size:0.8rem;margin-top:6px;">{{ $message }}</div>
                    @enderror
                </div>
                <div class="form-group">
                    ...
                    <input type="text" name="verified_by" id="verified_by" class="form-control" value="{{ old('verified_by', $report->verified_by) }}" placeholder="Name (optional)">
                    @error('verified_by')
                        <div style="color:var(--danger);font-size:0.8rem;margin-top:6px;">{{ $message }}</div>
                    @enderror
                </div>
...
<script>
    let itemIndex = 0;
    const existingItems = @json($report->items->sortBy(['expense_date'])->values());
    ...
    function addItem(data) {
        ...
        const payee = data ? data.payee : '';
        const costCode = data ? data.cost_code : '';
        ...
        row.innerHTML = `
            ...
            <td><input type="text" name="items[${itemIndex}][payee]" class="form-control" style="font-size:0.78rem;padding:6px 8px;" value="${payee}" required></td>
            <td><input type="text" name="items[${itemIndex}][cost_code]" class="form-control" style="font-size:0.78rem;padding:6px 8px;" value="${costCode}" required></td>
            <td><input type="text" name="items[${itemIndex}][particulars]" class="form-control" style="font-size:0.78rem;padding:6px 8px;" value="${particulars}" required></td>
            <td><input type="number" name="items[${itemIndex}][amount]" class="form-control item-amount" style="font-size:0.78rem;padding:6px 8px;" step="0.01" min="0.01" value="${amount}" required oninput="recalculate()"></td>
