...
return [
    ...
    'app_id' => env('NATIVEPHP_APP_ID', 'com.pettycash.monitor'),

    'deeplink_scheme' => env('NATIVEPHP_DEEPLINK_SCHEME'),

    'author' => env('NATIVEPHP_APP_AUTHOR', 'L.V. Ledesma Construction, Inc.'),

    'copyright' => env('NATIVEPHP_APP_COPYRIGHT', date('Y') . ' L.V. Ledesma Construction, Inc.'),

    'description' => env('NATIVEPHP_APP_DESCRIPTION', 'Petty Cash Fund Monitoring System'),
